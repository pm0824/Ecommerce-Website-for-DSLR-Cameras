        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="p_cat" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_categories"> Add Product Category </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_categories"> View Products Categories </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="cat" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_brands"> Add New Brand </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
            ...
            <li><!-- li begin -->
                ...
                <i class="fas fa-rupee-sign"></i> View Payments
                </a><!-- a href finish -->
            </li><!-- li finish -->
